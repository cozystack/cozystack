...
func (r *REST) New() runtime.Object     { return &appsv1alpha1.TenantNamespace{} }
func (r *REST) NewList() runtime.Object { return &appsv1alpha1.TenantNamespaceList{} }
...
func (r *REST) List(ctx context.Context, _ *metainternal.ListOptions) (runtime.Object, error) {
	...
	out := &appsv1alpha1.TenantNamespaceList{
	...
	for _, u := range nsList.Items {
		...
		out.Items = append(out.Items, appsv1alpha1.TenantNamespace{
			TypeMeta: metav1.TypeMeta{
				APIVersion: "apps.cozystack.io/v1alpha1",
...
func (r *REST) Get(ctx context.Context, name string, opts *metav1.GetOptions) (runtime.Object, error) {
	...
	return &appsv1alpha1.TenantNamespace{
		TypeMeta: metav1.TypeMeta{
			APIVersion: "apps.cozystack.io/v1alpha1",
			Kind:       "TenantNamespace",
		},
