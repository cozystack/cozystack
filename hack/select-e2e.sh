...
full_suite_pattern='^(packages/library/|packages/core/|api/|cmd/|internal/|hack/lib/|hack/[^/]+\.sh$|hack/[^/]+\.bats$|hack/e2e-apps/[^/]+\.sh$|Makefile$|\.github/workflows/(pull-requests|e2e-tag)\.yaml$)'
