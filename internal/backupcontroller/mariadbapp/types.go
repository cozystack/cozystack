...
// patch any apps.cozystack.io/MariaDB spec fields. It targets the downstream
// k8s.mariadb.com/MariaDB CR (rendered by the chart's HelmRelease) for both
// bootstrapFrom patching and existence checks.
//
// Reserved for future fields the driver might need to read (e.g. a backup
// section or a bootstrap shortcut analogous to postgres). Add fields here
