...
type BadgeConfig struct {
	Text  string // Optional abbreviation, auto-generated from Title if empty
	Color string // Optional custom backgroundColor override
	Title string // Resource kind/type value
}
...
func createUnifiedBadge(id string, config BadgeConfig) map[string]any {
	...
	// Add abbreviation if specified (otherwise ResourceBadge auto-generates from value)
	if config.Text != "" {
...
func createUnifiedBadgeFromKind(id, kind, title string) map[string]any {
	return map[string]any{
		"type": "ResourceBadge",
		"data": map[string]any{
			"id":    id,
