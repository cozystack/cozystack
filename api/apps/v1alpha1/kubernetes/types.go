...
type Talos struct {
	...
	InstallerRepository string `json:"installerRepository,omitempty"`
	...
	// +kubebuilder:default:={}
	RegistryMirrors k8sRuntime.RawExtension `json:"registryMirrors,omitempty"`
