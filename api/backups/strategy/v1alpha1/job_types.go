...
type JobSpec struct {
	...
	// pod to completion and create (or restore) a backup of a given app's
	// data. Helm-like Go templates are supported in every string field and
	...
	//     and `.Backup.ApplicationRef` describing the source backup.
