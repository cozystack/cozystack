...
func (in *ApplicationDefinitionRelease) DeepCopyInto(out *ApplicationDefinitionRelease) {
	*out = *in
	...
	if in.DependencyMappings != nil {
		in, out := &in.DependencyMappings, &out.DependencyMappings
		*out = make([]DependencyMapping, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DependencyMapping) DeepCopyInto(out *DependencyMapping) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DependencyMapping.
func (in *DependencyMapping) DeepCopy() *DependencyMapping {
	if in == nil {
		return nil
	}
	out := new(DependencyMapping)
	in.DeepCopyInto(out)
	return out
}
