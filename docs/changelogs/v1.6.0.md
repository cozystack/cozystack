...
Both are documented at [OIDC authentication for kubectl](https://cozystack.io/docs/v1.6/kubernetes/oidc-authentication/) and [OIDC authentication for Grafana](https://cozystack.io/docs/v1.6/operations/services/monitoring/oidc-authentication/).
...
* **[vm-instance] Document attaching a VM to an external VLAN**: New guide on [attaching a VM to an external VLAN](https://cozystack.io/docs/v1.6/networking/vm-external-vlan/), covering the Linux-bridge and bridge-type `NetworkAttachmentDefinition` path ([**@lexfrei**](https://github.com/lexfrei) in #3196).
