...
* **[apps] Add MongoDB managed application**: Added MongoDB as a new managed application, providing a fully managed MongoDB database with replica set support, automatic failover, and integrated backup capabilities ([**@lexfrei**](https://github.com/lexfrei) in #1822, #1881).
