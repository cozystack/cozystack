...
* [postgres] Add instructions for backing up and restoring PostgreSQL data in the application README. (@klinch0 and @NickVolynkin in https://github.com/cozystack/cozystack/pull/1141)
