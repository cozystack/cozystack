Cozystack v0.34.0-beta.1 is the first beta release in the series v0.34.x. It's focused on virtualization capabilities and improvements in the Cozystack API.
...
* Update LINSTOR to v1.31.2. (@kvaps in https://github.com/cozystack/cozystack/pull/1180d)
* Update KubeVirt to v1.5.2. (@kvaps in https://github.com/cozystack/cozystack/pull/1183d)
* Update CDI to v1.62.0. (@kvaps in https://github.com/cozystack/cozystack/pull/1183d)
* Update Flux Operator to 0.24.0. (@kingdonb in https://github.com/cozystack/cozystack/pull/1167d)
* Update Kamaji to edge-25.7.1. (@kvaps in https://github.com/cozystack/cozystack/pull/1184d)
