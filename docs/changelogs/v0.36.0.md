...
Release v0.36.0 is focusing on the stability, observability, and flexible configuration of managed applications.
...
Configurations include the ingress controller pods' CPU and memory requests/limits, either with direct values or using one of available presets.
...
It includes endpoings and methods for listing, creating, updating, and removing each managed application, defined as Cozystack CRD.
