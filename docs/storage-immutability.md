...
- `clickhouse`, `foundationdb`, `harbor`, `http-cache`, `kafka` (brokers + KRaft controllers), `kubernetes`, `kubernetes-nodes`, `mariadb`, `mongodb`, `nats`, `openbao`, `opensearch`, `postgres`, `qdrant`, `rabbitmq`, `redis`, `valkey`, `vm-disk`.
