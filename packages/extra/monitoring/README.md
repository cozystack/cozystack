...
| `metricsStorages[].vminsert.minAllowed.cpu`     | CPU resources                                                                                             | `quantity`         |        |
| `metricsStorages[].vminsert.maxAllowed.cpu`     | CPU resources                                                                                             | `quantity`         |        |
| `metricsStorages[].vmselect.minAllowed.cpu`     | CPU resources                                                                                             | `quantity`         |        |
| `metricsStorages[].vmselect.maxAllowed.cpu`     | CPU resources                                                                                             | `quantity`         |        |
| `metricsStorages[].vmstorage.minAllowed.cpu`    | CPU resources                                                                                             | `quantity`         |        |
| `metricsStorages[].vmstorage.maxAllowed.cpu`    | CPU resources                                                                                             | `quantity`         |        |
| `metricsStorages[].vminsert.minAllowed.memory`  | Memory resources                                                                                          | `quantity`         |        |
| `metricsStorages[].vminsert.maxAllowed.memory`  | Memory resources                                                                                          | `quantity`         |        |
| `metricsStorages[].vmselect.minAllowed.memory`  | Memory resources                                                                                          | `quantity`         |        |
| `metricsStorages[].vmselect.maxAllowed.memory`  | Memory resources                                                                                          | `quantity`         |        |
| `metricsStorages[].vmstorage.minAllowed.memory` | Memory resources                                                                                          | `quantity`         |        |
| `metricsStorages[].vmstorage.maxAllowed.memory` | Memory resources                                                                                          | `quantity`         |        |
