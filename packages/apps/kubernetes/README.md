...
| `addons.cilium`                               | Cilium CNI plugin. Always installed as the tenant cluster's CNI; this section only overrides its Helm values.                                                                  | `object`   | `{}`      |
...
| `addons.verticalPodAutoscaler`                | Vertical Pod Autoscaler. Installed and removed together with addons.monitoringAgents.enabled; this section only overrides its Helm values.                                     | `object`   | `{}`      |
...
| `addons.coredns`                              | CoreDNS addon. Always installed as the tenant cluster's DNS; this section only overrides its Helm values.                                                                      | `object`   | `{}`      |
