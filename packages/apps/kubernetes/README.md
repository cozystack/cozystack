...
| `nodeGroups`            | nodeGroups configuration                                                                                                               | see [values.yaml] |
...
| `controlPlane.apiServer.resourcesPreset`           | Set container resources according to a common preset. | `small`       |
| `controlPlane.controllerManager.resources`         | Resources                                             | `{}`          |
| `controlPlane.controllerManager.resourcesPreset`   | Set container resources according to a common preset. | `micro`       |
| `controlPlane.scheduler.resources`                 | Resources                                             | `{}`          |
| `controlPlane.scheduler.resourcesPreset`           | Set container resources according to a common preset. | `micro`       |
| `controlPlane.konnectivity.server.resources`       | Resources                                             | `{}`          |
| `controlPlane.konnectivity.server.resourcesPreset` | Set container resources according to a common preset. | `micro`       |
