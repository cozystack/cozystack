...
| `externalIPs[i].target`      | Which external endpoint to pin. `client` is the cluster Service carrying AMQP and management, the endpoint `external: true` publishes, and is the default.                                                                                                                                                                                                | `string`   | `""`      |
