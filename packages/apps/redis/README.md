...
| `externalIPs[i].target`   | Which external endpoint to pin. `master` is the Sentinel-elected master, the endpoint `external: true` publishes, and is the default.                                                                                                                                                                                                        | `string`   | `""`      |
