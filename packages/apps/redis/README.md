...
| `tls.ca.algorithm`                | Key algorithm. Ed25519 uses a fixed key; the size field is ignored.                                                                                                                                                        | `string`   | `ECDSA`                           |
| `tls.ca.size`                     | Key size in bits. Ignored for Ed25519.                                                                                                                                                                                     | `int`      | `256`                             |
...
| `tls.certificate.dnsNameSuffixes` | Service name suffixes used to auto-compute DNS SANs. Each suffix expands to four DNS forms using the release name and namespace.                                                                                           | `[]string` | `[master, replicas, external-lb]` |
| `tls.certificate.usages`          | Key usages.                                                                                                                                                                                                                | `[]string` | `[server auth]`                   |
| `tls.certificate.algorithm`       | Key algorithm. Ed25519 uses a fixed key; the size field is ignored.                                                                                                                                                        | `string`   | `ECDSA`                           |
| `tls.certificate.size`            | Key size in bits. Ignored for Ed25519.                                                                                                                                                                                     | `int`      | `256`                             |
