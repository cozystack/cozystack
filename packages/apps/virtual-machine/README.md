...
| `externalPorts`           | Specify ports to forward from outside the cluster                                                           | `[]int`     | `null`      |
...
| `systemDisk`              | System disk configuration                                                                                   | `object`    | `null`      |
| `systemDisk.image`        | The base image for the virtual machine. Allowed values: `ubuntu`, `cirros`, `alpine`, `fedora` and `talos`  | `string`    |             |
| `systemDisk.storage`      | The size of the disk allocated for the virtual machine                                                      | `string`    |             |
| `systemDisk.storageClass` | StorageClass used to store the data                                                                         | `*string`   |             |
...
| `resources.cpu`           | The number of CPU cores allocated to the virtual machine                                                    | `*quantity` |             |
| `resources.memory`        | The amount of memory allocated to the virtual machine                                                       | `*quantity` |             |
