...
| `externalIPs[i].target`   | Which external endpoint to pin. `endpoint` is the installation-wide Service covering every replica, the endpoint `external: true` publishes, and is the default.                                                                                                                                                                             | `string`   | `""`       |
